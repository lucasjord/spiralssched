...
def printpeakmag(src,tnow):
    ...
    text1 = 'SOURCE {0:3s} \033[0;0m RA {4:+3.2f}{2:3s} DEC {5:+3.2f}{3:3s}'.format(src,tnow*365.25,ratrend,dctrend,*current)
    print(text1)
...
def main():
	...
	tnow = (aTime.now()+dt).decimalyear%1
        mzrs = ['s1','s3','s4','s5','s6','s7','s8','s9','s10','s11','s13','s14','s15','s16','s17','s18','s19','s20','s21','s22','s23','s24']
        mzrs = ['s3','s4','s13','s14','s15','s16','s17','s18','s19','s20','s21','s22','s23','s24']
