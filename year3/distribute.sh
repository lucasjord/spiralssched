...
export START=$(grep exper_nominal_start /home/observer/correlations2/spiralssched/year3$1.vex | cut -d '=' -f 2 | tr -d ";")
export STOP=$(grep exper_nominal_stop /home/observer/correlations2/spiralssched/year3/$1.vex | cut -d '=' -f 2 | tr -d ";")
...
ssh oper@pcfscd 'cp /usr2/proc/spirals2.prc /usr2/proc/'$1cd.prc
...
ssh oper@pcfshb 'cp /usr2/proc/spirals2.prc /usr2/proc/'$1hb.prc
...
# drudg the vex file there
ssh oper@pcfske rm /usr2/sched/$1ke.snp
ssh oper@pcfske 'echo -e "ke\n3\n0\n"|/usr2/fs/bin/drudg '$1.vex
ssh oper@pcfske 'cp /usr2/proc/spirals2.prc /usr2/proc/'$1ke.prc
...
cd /home/observer/correlations2/$1/ && /home/observer/correlations2/corr_scripts/kludge_vex-2gbit.sh $1
